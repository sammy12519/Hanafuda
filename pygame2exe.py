...
class BuildExe:
    def __init__(self):
        ...
        #Auhor of program
        self.author_name = "Hsu, Hung-Wei"
        self.author_email = "d07942010@ntu.edu.tw"
        self.copyright = "Copyright (c) 2018."

        #Description
        self.project_description = "A hanafuda game with AIs"
